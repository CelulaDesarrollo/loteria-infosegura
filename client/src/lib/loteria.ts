...
export const CARDS: Card[] = [
  ...
  { id: 49, name: "EL DISI", imageUrl: "/cards/49.jpg", description: "El que conmemora con unión, la seguridad de la información.", descriptionLong: "Conmemoración del Día Internacional de la Seguridad de la Información que resalta la importancia de la protección de la información y fomenta buenas prácticas." },
  { id: 50, name: "EL SOFTWARE PIRATA", imageUrl: "/cards/50.jpg", description: "El que por tu seguridad, no debes instalar.", descriptionLong: "Programas sin licencia oficial que parecen gratuitos, pero exponen los equipos a infecciones de malware y no cuentan con los beneficios de un software con licencia (actualizaciones de seguridad, garantía)." },
